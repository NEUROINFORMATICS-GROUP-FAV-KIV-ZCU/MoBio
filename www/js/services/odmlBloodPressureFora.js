        ...
        .factory('odmlBloodPressureFora', function ($http, $q) {
            ...
            return {
                ...
                getSystolic: function (data) {
                    return data.odML.section[0].property[0].value.content;
                },
                getDiastolic: function (data) {
                    return data.odML.section[0].property[1].value.content;
                },
                getMean: function (data) {
                    return data.odML.section[0].property[2].value.content;
                },
                getHeartRate: function (data) {
                    return data.odML.section[0].property[3].value.content;
                },
                ...
                setSystolic: function (data, value) {
                    var result = data;
                    result.odML.section[0].property[0].value.content = value;
                    return result;
                },
                setDiastolic: function (data, value) {
                    var result = data;
                    result.odML.section[0].property[1].value.content = value;
                    return result;
                },
                setMean: function (data, value) {
                    var result = data;
                    result.odML.section[0].property[2].value.content = value;
                    return result;
                },
                setHeartRate: function (data, value) {
                    var result = data;
                    result.odML.section[0].property[3].value.content = value;
                    return result;
                }
            };
